...
function vault_to_network_address {
  ...
  case "$vault_node_name" in
    ...
    vault_2)
      ...
      ;;
    vault_3)
      echo "http://127.0.0.1:5300"
      ;;
    vault_4)
      echo "http://127.0.0.1:5400"
      ;;
    vault_5)
      echo "http://127.0.0.1:5500"
      ;;
    vault_6)
      echo "http://127.0.0.1:5600"
      ;;
    vault_7)
      echo "http://127.0.0.1:5700"
      ;;
  esac
}
...
function vault_1 {
    (export VAULT_ADDR=http://127.0.0.1:5100 && vault "$@")
}

# Create a helper function to address the second vault node
function vault_2 {
    (export VAULT_ADDR=http://127.0.0.1:5200 && vault "$@")
}

# Create a helper function to address the third vault node
function vault_3 {
    (export VAULT_ADDR=http://127.0.0.1:5300 && vault "$@")
}

# Create a helper function to address the fourth vault node
function vault_4 {
    (export VAULT_ADDR=http://127.0.0.1:5400 && vault "$@")
}

# Create a helper function to address the fourth vault node
function vault_5 {
    (export VAULT_ADDR=http://127.0.0.1:5500 && vault "$@")
}

# Create a helper function to address the fourth vault node
function vault_6 {
    (export VAULT_ADDR=http://127.0.0.1:5600 && vault "$@")
}

# Create a helper function to address the fourth vault node
function vault_7 {
    (export VAULT_ADDR=http://127.0.0.1:5700 && vault "$@")
}
...
function create_config {
  ...
  tee "$demo_home"/config-vault_1.hcl 1> /dev/null <<EOF
    storage "inmem" {}
    license_path = "$demo_home/license.hcl"
    listener "tcp" {
...
EOF
  ...
  listener "tcp" {
    ...
    cluster_address = "127.0.0.1:5201"
    tls_disable = true
  }
  seal "transit" {
  ...
  disable_mlock = true
  ui = true
  cluster_addr = "http://127.0.0.1:5201"
EOF
  ...
  storage "raft" {
    ...
    retry_join {
      leader_api_addr = "http://127.0.0.1:5200"
    }
  }
  license_path = "$demo_home/license.hcl"
  listener "tcp" {
    address = "127.0.0.1:5300"
    cluster_address = "127.0.0.1:5301"
    tls_disable = true
  }
  seal "transit" {
    address            = "http://127.0.0.1:5100"
  ...
  disable_mlock = true
  ui = true
  cluster_addr = "http://127.0.0.1:5301"
EOF
  ...
  listener "tcp" {
    ...
    cluster_address = "127.0.0.1:5401"
    tls_disable = true
  }
  seal "transit" {
    address            = "http://127.0.0.1:5100"
  ...
  disable_mlock = true
  ui = true
  cluster_addr = "http://127.0.0.1:5401"
EOF
...
listener "tcp" {
  ...
  cluster_address = "127.0.0.1:5501"
  tls_disable = true
}
seal "transit" {
  address            = "http://127.0.0.1:5100"
...
disable_mlock = true
ui = true
cluster_addr = "http://127.0.0.1:5501"
EOF
...
listener "tcp" {
  ...
  cluster_address = "127.0.0.1:5601"
  tls_disable = true
}
seal "transit" {
  address            = "http://127.0.0.1:5100"
...
disable_mlock = true
ui = true
cluster_addr = "http://127.0.0.1:5601"
EOF
...
listener "tcp" {
  ...
  cluster_address = "127.0.0.1:5701"
  tls_disable = true
}
seal "transit" {
  address            = "http://127.0.0.1:5100"
...
disable_mlock = true
ui = true
cluster_addr = "http://127.0.0.1:5701"
EOF
