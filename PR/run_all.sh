...
./cluster_pr.sh create config

# Setup the Vault server which provides unseal key
./cluster_pr.sh setup vault_1

# Setup vault_2 server
./cluster_pr.sh setup vault_2

# Setup vault_3 server
./cluster_pr.sh setup vault_3

# Setup vault_4 server
./cluster_pr.sh setup vault_4

# Setup vault_5 server
./cluster_pr.sh setup vault_5

# Setup vault_6 server
./cluster_pr.sh setup vault_6
