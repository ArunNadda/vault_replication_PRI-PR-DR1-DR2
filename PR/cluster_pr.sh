...
function vault_to_network_address {
  ...
  case "$vault_node_name" in
    vault_1)
      ...
      ;;
    vault_2)
      echo "http://127.0.0.1:7200"
      ;;
    vault_3)
      echo "http://127.0.0.1:7300"
      ;;
    vault_4)
      echo "http://127.0.0.1:7400"
      ;;
    vault_5)
...
function vault_1 {
    (export VAULT_ADDR=http://127.0.0.1:7100 && vault "$@")
}

# Create a helper function to address the second vault node
function vault_2 {
    (export VAULT_ADDR=http://127.0.0.1:7200 && vault "$@")
}

# Create a helper function to address the third vault node
function vault_3 {
    (export VAULT_ADDR=http://127.0.0.1:7300 && vault "$@")
}

# Create a helper function to address the fourth vault node
function vault_4 {
    (export VAULT_ADDR=http://127.0.0.1:7400 && vault "$@")
}

# Create a helper function to address the fourth vault node
function vault_5 {
    (export VAULT_ADDR=http://127.0.0.1:7500 && vault "$@")
}

# Create a helper function to address the fourth vault node
function vault_6 {
    (export VAULT_ADDR=http://127.0.0.1:7600 && vault "$@")
}

# Create a helper function to address the fourth vault node
function vault_7 {
    (export VAULT_ADDR=http://127.0.0.1:7700 && vault "$@")
}
...
EOF
  ...
  listener "tcp" {
    ...
    cluster_address = "127.0.0.1:7201"
    tls_disable = true
  }
  seal "transit" {
  ...
  disable_mlock = true
  ui = true
  cluster_addr = "http://127.0.0.1:7201"
EOF
  ...
  storage "raft" {
    ...
    retry_join {
      leader_api_addr = "http://127.0.0.1:7200"
    }
  }
  license_path = "$demo_home/license.hcl"
  listener "tcp" {
    address = "127.0.0.1:7300"
    cluster_address = "127.0.0.1:7301"
    tls_disable = true
  }
  seal "transit" {
    address            = "http://127.0.0.1:7100"
  ...
  disable_mlock = true
  ui = true
  cluster_addr = "http://127.0.0.1:7301"
EOF
  ...
  listener "tcp" {
    ...
    cluster_address = "127.0.0.1:7401"
    tls_disable = true
  }
  seal "transit" {
    address            = "http://127.0.0.1:7100"
  ...
  disable_mlock = true
  ui = true
  cluster_addr = "http://127.0.0.1:7401"
EOF
...
listener "tcp" {
  ...
  cluster_address = "127.0.0.1:7501"
  tls_disable = true
}
seal "transit" {
  address            = "http://127.0.0.1:7100"
...
disable_mlock = true
ui = true
cluster_addr = "http://127.0.0.1:7501"
EOF
...
listener "tcp" {
  ...
  cluster_address = "127.0.0.1:7601"
  tls_disable = true
}
seal "transit" {
  address            = "http://127.0.0.1:7100"
...
disable_mlock = true
ui = true
cluster_addr = "http://127.0.0.1:7601"
EOF
...
listener "tcp" {
  ...
  cluster_address = "127.0.0.1:7701"
  tls_disable = true
}
seal "transit" {
  address            = "http://127.0.0.1:7100"
...
disable_mlock = true
ui = true
cluster_addr = "http://127.0.0.1:7701"
EOF
