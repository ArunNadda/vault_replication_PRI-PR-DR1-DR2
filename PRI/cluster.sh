...
function start {
  case "$1" in
    ...
    *)
      printf "\n%s" \
        "Usage: $script_name start [all|vault_1|vault_2|vault_3|vault_4|vault_5|vault_6|vault_7]" \
        ""
      ;;
    esac
}
...
case "$1" in
  ...
  *)
    printf "\n%s" \
      ...
      "" \
      "Usage: $script_name [create|setup|status|stop|start|clean|vault_1|vault_2|vault_3|vault_4|vault_5|vault_6|vault_7]" \
      ""
    ;;
esac
