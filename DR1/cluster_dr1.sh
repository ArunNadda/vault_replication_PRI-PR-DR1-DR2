...
function vault_to_network_address {
  ...
  case "$vault_node_name" in
    ...
    vault_5)
      ...
      ;;
    vault_6)
      echo "http://127.0.0.1:9600"
      ;;
    vault_7)
      echo "http://127.0.0.1:9700"
      ;;
  esac
}
...
function vault_1 {
    (export VAULT_ADDR=http://127.0.0.1:9100 && vault "$@")
}

# Create a helper function to address the second vault node
function vault_2 {
    (export VAULT_ADDR=http://127.0.0.1:9200 && vault "$@")
}

# Create a helper function to address the third vault node
function vault_3 {
    (export VAULT_ADDR=http://127.0.0.1:9300 && vault "$@")
}

# Create a helper function to address the fourth vault node
function vault_4 {
    (export VAULT_ADDR=http://127.0.0.1:9400 && vault "$@")
}

# Create a helper function to address the fourth vault node
function vault_5 {
    (export VAULT_ADDR=http://127.0.0.1:9500 && vault "$@")
}

# Create a helper function to address the fourth vault node
function vault_6 {
    (export VAULT_ADDR=http://127.0.0.1:9600 && vault "$@")
}

# Create a helper function to address the fourth vault node
function vault_7 {
    (export VAULT_ADDR=http://127.0.0.1:9700 && vault "$@")
}
...
EOF
  ...
  disable_mlock = true
  ui = true
  cluster_addr = "http://127.0.0.1:9301"
EOF
  ...
  listener "tcp" {
    ...
    cluster_address = "127.0.0.1:9401"
    tls_disable = true
  }
  seal "transit" {
    address            = "http://127.0.0.1:9100"
  ...
  disable_mlock = true
  ui = true
  cluster_addr = "http://127.0.0.1:9401"
EOF
...
disable_mlock = true
ui = true
cluster_addr = "http://127.0.0.1:9501"
EOF
...
listener "tcp" {
  ...
  cluster_address = "127.0.0.1:9601"
  tls_disable = true
}
seal "transit" {
  address            = "http://127.0.0.1:9100"
...
disable_mlock = true
ui = true
cluster_addr = "http://127.0.0.1:9601"
EOF
...
listener "tcp" {
  ...
  cluster_address = "127.0.0.1:9701"
  tls_disable = true
}
seal "transit" {
  address            = "http://127.0.0.1:9100"
...
disable_mlock = true
ui = true
cluster_addr = "http://127.0.0.1:9701"
EOF
